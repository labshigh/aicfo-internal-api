...
@Builder
public class ItemBuyAdminWithdrawalRequestRequestValidator implements Validator {

  @Override
  public boolean supports(Class<?> clazz) {
    return ItemBuyAdminWithdrawalRequestRequestModel.class.equals(clazz);
  }

  @Override
  public void validate(Object target, Errors errors) {
    ItemBuyAdminWithdrawalRequestRequestModel requestModel = (ItemBuyAdminWithdrawalRequestRequestModel) target;
