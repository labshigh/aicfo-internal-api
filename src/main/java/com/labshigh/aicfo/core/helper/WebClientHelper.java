package com.labshigh.aicfo.core.helper;
...
public class WebClientHelper {
  ...
  private static final String REQUEST_HOST_HEADER = "X-REQUEST-HOST";
  @Getter @Setter
  private String requestHost = null;

  private static final String REQUEST_PACKAGE_VERSION_HEADER = "X-PACKAGE-VERSION";
  @Getter @Setter
