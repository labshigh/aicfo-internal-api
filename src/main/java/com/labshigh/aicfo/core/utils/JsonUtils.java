...
import com.labshigh.aicfo.core.helper.GsonDateTimeConverter;
import com.labshigh.aicfo.core.helper.GsonDateConverter;
...
public class JsonUtils {
  ...
  public static <T> T convertJsonStringToMap(String jsonString, Type type){
    T obj;
    try {
